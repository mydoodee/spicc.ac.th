        ...
        const loadData = async () => {
            try {
                ...
                if (settingsRes.success && settingsRes.settings) {
                    const dbSettings = settingsRes.settings;
                    // Force removal of "และกิจกรรม" from the title if it exists from DB
                    if (dbSettings.news_title) {
                        dbSettings.news_title = dbSettings.news_title.replace('และกิจกรรม', '').trim();
                    }
