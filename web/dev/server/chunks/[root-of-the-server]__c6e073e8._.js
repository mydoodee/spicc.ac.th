...
"[project]/app/api/landing-page/route.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET() {
    try {
        const landing = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])('SELECT * FROM cms_landing_page LIMIT 1');
        if (landing.length === 0) {
...
async function PUT(request) {
    try {
        ...
        const landing = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])('SELECT id FROM cms_landing_page LIMIT 1');
        if (landing.length === 0) {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])(`
...
//# sourceMappingURL=%5Broot-of-the-server%5D__c6e073e8._.js.map