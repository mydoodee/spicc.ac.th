...
async function GET() {
    try {
        const settings = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])('SELECT * FROM cms_site_settings ORDER BY id DESC LIMIT 1');
...
async function PUT(req) {
    try {
        const user = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getAuthUser"])(req);
        if (!user) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: 'Unauthorized'
            }, {
        ...
        const { site_name, site_logo, site_logo_url, site_favicon_url, site_title_suffix, site_subtitle, register_link, register_button_text } = await req.json();
        // Check if settings exist
        const existing = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])('SELECT id FROM cms_site_settings LIMIT 1');
        if (existing.length > 0) {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])(`UPDATE cms_site_settings SET 
                site_name = ?, 
                site_logo = ?, 
                site_logo_url = ?, 
                site_favicon_url = ?,
            ...
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])(`INSERT INTO cms_site_settings 
                (site_name, site_logo, site_logo_url, site_favicon_url, site_title_suffix, site_subtitle, register_link, register_button_text) 
                VALUES (?, ?, ?, ?, ?, ?, ?, ?)`, [
                site_name,
                site_logo,
                site_logo_url,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__7d8a1b7e._.js.map