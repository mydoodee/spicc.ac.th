...
"[project]/app/api/about/route.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET() {
    try {
        const settings = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])('SELECT * FROM cms_about_settings LIMIT 1');
...
async function PUT(request) {
    try {
        ...
        const existing = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])('SELECT id FROM cms_about_settings LIMIT 1');
        if (existing.length > 0) {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])('UPDATE cms_about_settings SET title = ?, title_highlight = ?, description = ? WHERE id = ?', [
                title,
                title_highlight,
                description,
                existing[0].id
            ...
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])('INSERT INTO cms_about_settings (title, title_highlight, description) VALUES (?, ?, ?)', [
                title,
                title_highlight,
                description
            ]);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__261abdb6._.js.map