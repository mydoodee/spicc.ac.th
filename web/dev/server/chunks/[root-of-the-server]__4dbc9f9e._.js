...
"[project]/app/api/menus/route.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(request) {
    try {
        ...
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])('INSERT INTO cms_menus (title, url, page_id, course_id, news_id, parent_id, sort_order, is_active) VALUES (?, ?, ?, ?, ?, ?, ?, ?)', [
            title,
            url || null,
            page_id || null,
            course_id || null,
...
async function PATCH(request) {
    try {
        ...
        for (const item of updates){
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])('UPDATE cms_menus SET sort_order = ? WHERE id = ?', [
                item.sort_order,
                item.id
            ]);
        }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__4dbc9f9e._.js.map