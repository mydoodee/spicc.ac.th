...
"[project]/app/api/courses/settings/route.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET() {
    try {
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])('SELECT * FROM cms_courses_settings LIMIT 1');
...
async function PUT(request) {
    try {
        ...
        const existing = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])('SELECT id FROM cms_courses_settings LIMIT 1');
        if (existing.length > 0) {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])('UPDATE cms_courses_settings SET courses_title=?, courses_description=? WHERE id=?', [
                courses_title,
                courses_description,
                existing[0].id
            ]);
        } else {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])('INSERT INTO cms_courses_settings (courses_title, courses_description) VALUES (?, ?)', [
                courses_title,
                courses_description
            ]);
        }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__3d56f797._.js.map